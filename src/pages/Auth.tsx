    ...
    <>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                minLength={6}
                className="h-11 font-mono bg-muted/50 border-primary/30 focus:border-primary focus:shadow-glow transition-all"
              />
            </div>
            <div className="space-y-2">
      ...
      <div className="min-h-screen flex items-center justify-center gradient-bg p-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 right-20 w-80 h-80 rounded-full bg-[hsl(var(--cyber-pink))]/15 blur-3xl animate-float" style={{ animationDelay: '-2s' }} />
          <div className="absolute top-1/2 left-1/3 w-96 h-96 rounded-full bg-accent/10 blur-3xl animate-float" style={{ animationDelay: '-4s' }} />
          <div className="absolute bottom-1/3 right-1/3 w-72 h-72 rounded-full bg-[hsl(var(--cyber-purple))]/10 blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
        </div>
            ...
            <div className="inline-flex items-center justify-center mb-4">
              <div className="relative group">
                ...
                <img 
                  ...
                  alt="NelTech Logo" 
                  className="relative h-24 w-24 rounded-2xl shadow-glow border-2 border-primary/50 hover:scale-105 transition-transform"
                />
              </div>
            </div>
              ...
              {showResetPassword ? (
                <form onSubmit={handleResetPassword} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        required
                        className="h-12 pl-10 font-mono bg-muted/50 border-primary/30 focus:border-accent focus:shadow-glow-cyan transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <Button
                    type="button"
                    variant="ghost"
                    className="w-full font-mono hover:text-primary hover:bg-primary/10 transition-all"
                  ...
                  <TabsContent value="signin">
                    <form onSubmit={handleSignIn} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            ...
                            required
                            className="h-12 pl-10 font-mono bg-muted/50 border-primary/30 focus:border-[hsl(var(--cyber-pink))] focus:shadow-glow-pink transition-all"
                          />
                        </div>
                      </div>
                      <Button type="submit" className="w-full h-12 font-mono gradient-primary hover:shadow-glow transition-all text-primary-foreground font-semibold" disabled={isLoading}>
                      ...
                      <Button
                        type="button"
                        variant="link"
                        className="w-full text-xs font-mono text-muted-foreground hover:text-[hsl(var(--cyber-pink))] transition-colors"
